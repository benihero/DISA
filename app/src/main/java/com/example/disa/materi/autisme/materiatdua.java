...
public class materiatdua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materiatdua);
        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaiat2);
    ...
    public void pindahat2(View view){

        Intent intent = new Intent(materiatdua.this, materiattiga.class);
        startActivity(intent);
        finish();


    }
    public void pindahat2back(View view){

        Intent intent = new Intent(materiatdua.this, materiatsatu.class);
        startActivity(intent);
        finish();
    ...
    public void selesaiat2(View view){
