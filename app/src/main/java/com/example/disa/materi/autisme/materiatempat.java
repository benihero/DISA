...
public class materiatempat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materiatempat);
        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaiat4);
    ...
    public void pindahat4(View view){

        Intent intent = new Intent(materiatempat.this, materiatlima.class);
        startActivity(intent);
        finish();


    }
    public void pindahat4back(View view){

        Intent intent = new Intent(materiatempat.this, materiattiga.class);
        startActivity(intent);
        finish();
    ...
    public void selesaiat4(View view){
