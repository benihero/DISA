...
public class materitnempat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materitnempat);
        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaitd4);
    ...
    public void pindahtd4(View view){

        Intent intent = new Intent(materitnempat.this, materitnlima.class);
        startActivity(intent);
        finish();


    }
    public void pindahtd4back(View view){

        Intent intent = new Intent(materitnempat.this, materitntiga.class);
        startActivity(intent);
        finish();
    ...
    public void selesaitd4(View view){
