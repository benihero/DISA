...
public class materisatu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materisatu);

        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaitn1);
    ...
    public void pindah1(View view){
        ...
        Intent intent = new Intent(materisatu.this,materidua.class);
    ...
    public void pindah1back(View view){

        Intent intent = new Intent(materisatu.this, ListMateri.class);
        startActivity(intent);
        finish();
