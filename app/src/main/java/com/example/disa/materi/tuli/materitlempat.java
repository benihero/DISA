...
public class materitlempat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materitlempat);

        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaitl4);
    ...
    public void pindahtl4(View view){

        Intent intent = new Intent(materitlempat.this, materitllima.class);
    ...
    public void pindahtl4back(View view){

        Intent intent = new Intent(materitlempat.this, materitltiga.class);
        startActivity(intent);
        finish();
    ...
    public void selesaitl4(View view){
