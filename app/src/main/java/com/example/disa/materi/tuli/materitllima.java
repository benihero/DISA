...
public class materitllima extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materitllima);

        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaitl5);
    ...
    public void pindahtl5(View view){

        Intent intent = new Intent(materitllima.this, materitlenam.class);
    ...
    public void pindahtl5back(View view){

        Intent intent = new Intent(materitllima.this, materitlempat.class);
        startActivity(intent);
        finish();
    ...
    public void selesaitl5(View view){
