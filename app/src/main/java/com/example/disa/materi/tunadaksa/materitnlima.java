...
public class materitnlima extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materitnlima);
        getUsernameLocal();
        if (username_key_new.isEmpty()){


            Button tn1 = findViewById(R.id.selesaitd5);
    ...
    public void pindahtd5(View view){

        Intent intent = new Intent(materitnlima.this, materitnenam.class);
        startActivity(intent);
        finish();


    }
    public void pindahtd5back(View view){

        Intent intent = new Intent(materitnlima.this, materitnempat.class);
        startActivity(intent);
        finish();
    ...
    public void selesaitd5(View view){
