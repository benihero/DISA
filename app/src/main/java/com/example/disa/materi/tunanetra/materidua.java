...
public class materidua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (username_key_new.isEmpty()){
            ...
            Button tn1 = findViewById(R.id.selesaitn2);
    ...
    public void pindah2(View view){
        ...
        Intent intent = new Intent(materidua.this,materitiga.class);
    ...
    public void pindah2back(View view){

        Intent intent = new Intent(materidua.this,materisatu.class);
        startActivity(intent);
        finish();
    ...
    public void selesaitn2(View view){
