...
public class tulivideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tulivideo);


        playone = findViewById(R.id.playone);
        playtwo = findViewById(R.id.playtwo);
        back = findViewById(R.id.back_videotuli);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tulivideo.this,Lihat_Video.class);
            ...
            public void onClick(View v) {
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        vid_url = dataSnapshot.child("videodua").getValue().toString();

                        Intent intent = new Intent(tulivideo.this, PlayVideo.class);
            ...
            public void onClick(View v) {
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        vid_url = dataSnapshot.child("videosatu").getValue().toString();
